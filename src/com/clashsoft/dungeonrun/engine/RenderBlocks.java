...
{	
	...
	{	
		if (block != null && !block.isAir() && block.getBlock() != null)
		{
			...
			{
				Image image1 = block.getBlock().getBlockTextureFromSideAndMetadata(0, block.getMetadata()); //0 = Top
				if (image1 != null)
				{
			...
			{
				Image image2 = block.getBlock().getBlockTextureFromSideAndMetadata(4, block.getMetadata()); //5 = South
				if (image2 != null)
				{

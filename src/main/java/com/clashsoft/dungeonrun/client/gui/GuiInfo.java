...
public class GuiInfo extends GuiScreen
{
	...
	public void drawScreen(Graphics g, int par1, int par2)
	{
		...
		this.dr.fontRenderer.drawStringWithShadow((par1 - this.dr.fontRenderer.getStringWidth(this.message)) / 2,
		                                          (par2 - this.dr.fontRenderer.getStringHeigth(this.message)) / 2,
